...
class RandomFactIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        # type: (HandlerInput) -> Response
        speak_output = "Here is a random fact! This skill's creator name is Pratham Gupta"
...
class SpecificFactIntentHandler(AbstractRequestHandler):
    """Handler for Hello World Intent."""
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool
        return ask_utils.is_intent_name("SpecificFactIntent")(handler_input)

    def handle(self, handler_input):
        slots=handler_input.request_envelope.request.intent.slots
        factTopic=slots["FactType"].value
        # type: (HandlerInput) -> Response
...
sb.add_request_handler(SpecificFactIntentHandler())
